...
function table() {
  const data = [['1', '《长生殿》 ', '昆曲'], ['2', '《桃花扇》 ', '昆曲'],
  ['3', '《西厢记》 ', '元杂剧'], ['4', '《牡丹亭》 ', '昆曲'], ['5', '《秦香莲》 ', '京剧'],
  ['6', '《王宝钏》 ', '秦腔'],
  ['7', '《打金枝》 ', '京剧'],
  ['8', '《穆桂英挂帅》 ', '京剧'],
...
function line() {
  ...
  option = {
    ...
    xAxis: [{
      type: 'category',
      data: ['清朝末年', '1949年', '1982年', '2004年', '2017年'],
      axisLabel: {
        show: true,
        rotate: 35, // 将标签倾斜45度
        textStyle: {
...
function stock() {
  ...
  option = {
    ...
    series: [{
      ...
      data: [
        { value: 4.64, name: '京剧' },
        { value: 4.0675, name: '黄梅戏' },
        { value: 3.4175, name: '越剧' },
        { value: 2.78, name: '豫剧' },
        { value: 2.7075, name: '昆曲' },
        { value: 2.6675, name: '秦腔' }
      ]
    }]
  };
